Shader "Sun/SunShader" //Dear carmine: most of this code is from a github repository for this particular shader, i hope you do not mind me using it
{
		...
		SubShader{
			...
			Pass {
				...
				v2f vert(appdata_base v)
				{
					...
					//add cos of y pos * time, mult all variables. 
